...
export interface CustomVerifierInterface extends utils.Interface {
  functions: {
    ...
    "verifiedZKPs(uint256)": FunctionFragment;
  ...
  events: {
    ...
    "ZKPsVerified(bytes32,address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "ZKPsVerified"): EventFragment;
}
...
export interface ZKPsVerifiedEventObject {
  commitmentId: string;
  proverAddress: string;
}
export type ZKPsVerifiedEvent = TypedEvent<
  [string, string],
  ZKPsVerifiedEventObject
>;

export type ZKPsVerifiedEventFilter = TypedEventFilter<ZKPsVerifiedEvent>;

export interface CustomVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CustomVerifierInterface;
  ...
  functions: {
    ...
    verifiedZKPs(
      ...
      [ICustomVerifier.ZkpStructOutput, boolean] & {
        zkp: ICustomVerifier.ZkpStructOutput;
        isValid: boolean;
      }
    >;
  ...
  filters: {
    ...
    "ZKPsVerified(bytes32,address)"(
      commitmentId?: PromiseOrValue<BytesLike> | null,
      proverAddress?: PromiseOrValue<string> | null
    ): ZKPsVerifiedEventFilter;
    ZKPsVerified(
      commitmentId?: PromiseOrValue<BytesLike> | null,
      proverAddress?: PromiseOrValue<string> | null
    ): ZKPsVerifiedEventFilter;
