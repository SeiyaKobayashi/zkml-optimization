...
export declare namespace ICustomVerifierFactory {
...
export interface CustomVerifierFactoryInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "ChildContractCreated(address,bytes32,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "ChildContractCreated"): EventFragment;
}

export interface ChildContractCreatedEventObject {
  contractAddress: string;
  modelContentId: string;
  modelOwnerAddress: string;
}
export type ChildContractCreatedEvent = TypedEvent<
  [string, string, string],
  ChildContractCreatedEventObject
>;

export type ChildContractCreatedEventFilter =
  TypedEventFilter<ChildContractCreatedEvent>;

export interface CustomVerifierFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CustomVerifierFactoryInterface;
  ...
  functions: {
    ...
    getModels(
      ...
      overrides?: CallOverrides
    ): Promise<[ICustomVerifierFactory.ModelArrayElementStructOutput[]]>;
  ...
  filters: {
    "ChildContractCreated(address,bytes32,address)"(
      contractAddress?: PromiseOrValue<string> | null,
      modelContentId?: PromiseOrValue<BytesLike> | null,
      modelOwnerAddress?: PromiseOrValue<string> | null
    ): ChildContractCreatedEventFilter;
