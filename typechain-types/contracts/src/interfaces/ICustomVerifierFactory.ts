...
export interface ICustomVerifierFactoryInterface extends utils.Interface {
  functions: {
...
export interface ICustomVerifierFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICustomVerifierFactoryInterface;
