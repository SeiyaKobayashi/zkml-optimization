...
export interface ICircomVerifierInterface extends utils.Interface {
  functions: {
...
export interface ICircomVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICircomVerifierInterface;
